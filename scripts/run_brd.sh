...
do
if (( "$DOY" <= 9 )) ;then
wget -N ftp://cddis.gsfc.nasa.gov/gnss/data/daily/"$GPSYEAR"/brdc/BRDC00IGS_R_"$GPSYEAR"00"$DOY"0000_01D_MN.rnx.gz
...
wget -N ftp://cddis.gsfc.nasa.gov/gnss/data/daily/"$GPSYEAR"/brdc/BRDC00IGS_R_"$GPSYEAR"0"$DOY"0000_01D_MN.rnx.gz
...
if (( "$DOY" >= 100 )) ;then
wget -N ftp://cddis.gsfc.nasa.gov/gnss/data/daily/"$GPSYEAR"/brdc/BRDC00IGS_R_"$GPSYEAR""$DOY"0000_01D_MN.rnx.gz
