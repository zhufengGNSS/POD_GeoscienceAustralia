...
program test_yaml
   ...
   integer*2 pod_mode, get_pod_mode
   integer*2 ic_input_format, get_input_format
   integer*2 ic_input_refsys, get_input_refsys
   ...
   ! srp_parameters are a bitfield type for all variables, 6 ECOM biases, 8 ECOM cprs, 3 EMP biases, 3 EMP cprs.
   ! NB EMP bits are 17-22
   integer*4 default_srp_parameters, get_srp_parameters, srp_parameters_defined
   ! tidal effects are a bitfield type, 1 = solid_nonfreq, 2 = solid_freq, 3 = ocean, 4 = solid_pole, 5 = ocean_pole
   integer*2 eqm_tidal_effects, veq_tidal_effects, get_tidal_effects
   ...
   ! non grav effects are a bitfield type
   integer*2 eqm_non_grav_effects, veq_non_grav_effects, get_non_grav_effects
...
subroutine get_logical_parameter(dict, error, label, listall, parameters, idx, defined)
   ...
   logical listall
   integer*4 parameters, defined, pow
   integer*4 idx
   character(*) label
   logical value
