...
C =============================================================================
C FORM A ORBIT-NORMAL ATTITUDE FOR BDS GEO SATELLITE (ONLY FOR TESTING PURPOSE).
C BECAUSE THE IMPACT OF EARTH ALBEDO IS MOSTLY ON THE RADIAL DIRECTION,
C THE CONTRIBUTIONS FROM X AND Y SIDES ARE ZERO NO MATTER WHAT THE
C SATELLITE IS OPERATED WITH YS OR ON ATTITUDE. THIS IS BECAUSE THE
C EARTH RADIATION DIRECTION (RADIAL DIRECTION) IS PERPENDICULAR TO THE
C OTHER TWO AXES (Y AND X). THE ACCELERATION IS ONLY
C RESULTED FROM THE Z SIDE AND THE SOLAR PANEL. IN A CASE OF SMALL BETA ANGLES, 
C THE DIFFERENCE IN ACCELERATION AT THE SOLAR PANEL BETWEEN YS AND ON ATTITUDES 
C IS A COSINE FUNCTION OF THE BETA ANGLE. AS A RESULT, THE IMPACT
C OF EARTH ALBEDO ON YAW-STERRING IS SIMILAR TO THAT ON ORBIT-NORMAL AT
C THE SMALL BETA ANGLES. (04-11-2019 Dr. TZUPANG TSENG)

C FOR BDS IGSO ECLIPSING PERIOD (BETA < 4 DEG), THE CONTRIBUTION OF
C COSINE(4DEG) FROM THE SOLAR PANEL IN ON ATTITUDE IS SIMILAR TO THAT IN
C YS ATTITUDE. (05-11-2019 Dr. TZUPANG TSENG)
C =============================================================================
         IF(BLKNUM == 301)THEN
...
C        D VECTOR RESULTED FROM ORBIT-NORMAL ATTITUDE
