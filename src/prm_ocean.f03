...
! ----------------------------------------------------------------------
      INTEGER (KIND = prec_int2) :: ForceMod, ForceMod_Tides, ForceMod_Ocean  
! ----------------------------------------------------------------------
! Tides
...
If (ForceMod_Tides == 1) Then

! ----------------------------------------------------------------------
! Ocean Tides
!IF (FMOD_TIDES(3) == 1) Then
IF (ForceMod_Ocean == 1) Then
